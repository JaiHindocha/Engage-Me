...
$sql = ("SELECT coordinatesX,coordinatesY,pinType,student.firstName,student.lastName,boards.date FROM boardPin,boards,student,studentClass WHERE boardPin.boardID = boards.boardID AND boards.classID = '$classID' AND student.studentID = studentClass.studentID
