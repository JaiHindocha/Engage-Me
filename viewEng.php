    ...
    var xmlhttp = new XMLHttpRequest();
      ...
      xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
              ...
              for (i=0;i<myRecords.className.length;i++) {
                  ...
                  var newYear = "<option value="+myRecord.classID+">"+myRecord.className+"</option>";
                  year = year+newYear;
              }
              document.getElementById("classlist").innerHTML = year;
          }
      };
      xmlhttp.open("GET", "ajax/get_class_for_eng.php", true);
      xmlhttp.send();
      ...
      $(function () {
          $('#selectclass').on('submit', function (e) {
            ...
            $.ajax({
              type: 'POST',
              url: 'ajax/get_student_class_engagement.php',
              data: $(this).serialize(),
          ...
          <div class="ui horizontal divider">View Engagement</div>
            ...
            <div id='div1' class="ui form segment">
              <form id='selectclass'>
                ...
                <button class="ui fluid primary submit button" name="submit_button" id="submit_button" type="submit">Select Class</button>
              </form>
            </div>
