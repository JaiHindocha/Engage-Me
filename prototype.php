                ...
                function init() {
                  ...
                  if (myRecords.success==1){
                    for (i=0;i<myRecords.pin.length;i++) {
                      ...
                      var description = myRecord.taskName+', '+myRecord.pinType;
                      s.addShape(new Shape(parseInt(myRecord.coordinatesX),parseInt(myRecord.coordinatesY),0,0,'',true));
      ...
      <div class="row row-bottom-padded-md">
        <div class="ui raised text container segment">
          <div class="ui horizontal divider">View Engagement</div>
           ...
           <canvas id = "canvas1" width="600" height="600" hidden></canvas>
           <style>
           canvas {
                padding: 0;
                margin: auto;
