...
$sql = ("SELECT teacherID,firstName,lastName,email,isHead,department FROM teacher,department WHERE teacher.departmentID = department.departmentID AND teacher.adminVerified = 1 AND teacher.active = 1 ORDER BY department,firstName");
