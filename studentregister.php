...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "SELECT yearID FROM year WHERE year = '$year'";
    $result = $db->get_con()->query($sql);
    ...
    if(empty($email_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO student (email, firstName, lastName, password, gender, active, emailVerified, yearID) VALUES ('$email', '$firstname', '$lastname', '$param_password', '$gender', 1, 0, '$yearID')";
        $result = $db->get_con()->query($sql);
      ...
      <div class="fh5co-narrow-content">
        <div class="row row-bottom-padded-md">
          <div class="ui raised text container segment">
              <div class="ui horizontal divider">Student Sign Up</div>
              <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                  <div class="ui form segment">
                      ...
                      <div class="two fields">
                          ...
                          <div class="field">
              							Year <select id="year" name="year" class="ui search dropdown">
              							</select>
                          </div>
                      </div>
