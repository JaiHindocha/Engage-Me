                ...
                data: $(this).serialize(),
                  ...
                  if (myRecords.success==1){
      							for (i=0;i<myRecords.students.length;i++) {
      								...
      								var newstudent = "<div><h>"+myRecord.firstName+' '+myRecord.lastName+"</h>"+"<div style='float:right'><button type='button' onclick='foo(this.id)' id="+myRecord.studentID+" class='compact negative ui button'>Remove</button></div></div><br>";
    ...
    function foo(id){
      ...
      $.ajax({
             ...
             success: function(data){
               $.ajax({
                 type: 'POST',
                 url: 'ajax/get_students_head.php',
